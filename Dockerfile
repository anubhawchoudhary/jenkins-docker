...
ARG JENKINS_CLI=/var/jenkins-cli

ENV JENKINS_HOME $JENKINS_HOME
ENV JENKINS_SLAVE_AGENT_PORT ${agent_port}
ENV REF $REF
ENV JENKINS_CLI $JENKINS_CLI
...
RUN mkdir -p $JENKINS_CLI 
COPY jenkins-cli.jar $JENKINS_CLI
RUN chown -R ${uid}:${gid} $JENKINS_CLI
